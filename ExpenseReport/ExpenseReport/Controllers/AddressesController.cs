...
namespace ExpenseReport.Controllers
{
    ...
    {
        private AddressesContext db = new AddressesContext();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AddressID,StreetNumber,StreetName,City,State,ZipCode")] Address address)
        {
            if (ModelState.IsValid)
            {
